...
/**
 * Where the platform refuses — the same refused tool calls the Refusal rate tile counts, on
 * whichever of two axes the reader picks.
 *
 * The two axes answer different questions and neither can be derived from the other. One tool
 * refusing for nine reasons is a surface somebody should look at; nine tools refusing with one
 * identical message is a single bug with nine symptoms.
 *
 * DELIBERATE: no colour. Every row here is a refusal, so the bars are the neutral population tone
 * and their length does the ranking. And no headline callout: the first bar already draws the top
 * share with its figure beside it.
 */
