 ...
 * is read what it says. The flow page could report a skill's score and never show a line of
 * what that skill asks for — a number about something the reader cannot see.
 */
