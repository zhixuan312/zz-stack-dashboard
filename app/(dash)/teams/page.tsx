...
export default function TeamsPage() {
  ...
  return (
    <DashboardPage
      title="Teams"
      description="Every team on the platform. “Recorded work” counts events naming the team’s own initiatives — not admin actions, and not documents loaded in from elsewhere."
      showPeriod={false}
      updatedAt={new Date()}
    >
      <Query query={q}>
        {(d) => (
          <Panel title="All teams" aside={`${d.teams.length} total`} padded={false}>
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="text-right">Recorded work</TableHead>
